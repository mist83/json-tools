...
2. Let semantic build consume raw UTF-8 object bytes.
...
4. Capture peak-process memory, not only managed allocation totals.
...
5. Measure object-materialization paths separately from raw scan speed.
